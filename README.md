Hi ![](https://user-images.githubusercontent.com/18350557/176309783-0785949b-9127-417c-8b55-ab5a4333674e.gif)My name is Павел Кожеватов
=======================================================================================================================================

Frontend - разработчик
----------------------

Меня зовут Павел, я начал изучать веб-программирование в 2022 году. В настоящее время я изучаю JavaScript по программе Богдана Стащука и пробую создавать дефолтные макеты сайтов. Я прошел онлайн-курсы на сайте Frutecode и очень увлечен этой областью работы. В будущем я хотел бы полностью посвятить себя этой профессии и стать веб-программистом.

* 🌍  I'm based in Нефтеюганск
* 🖥️  See my portfolio at [Резюме](https://pavelpsiho.github.io/resume-test/)
